...
CKEDITOR.stylesSet.add('mystyles', [
    ...
    { name: 'Left Aligned Photo', element: 'img', attributes: { 'class': 'uk-align-center uk-align-left@m uk-margin-remove-adjacent align_left' } },
    { name: 'Right Aligned Photo', element: 'img', attributes: { 'class': 'uk-align-center uk-align-right@m uk-margin-remove-adjacent align_right' } },
    { name: 'Centered Photo', element: 'img', attributes: { 'class': 'uk-align-center align_center' } },
    { name: 'Small', element: 'small' },
    { name: 'Deleted Text', element: 'del' },
    { name: 'Inserted Text', element: 'ins' },
    { name: 'Cited Work', element: 'cite' },
    { name: 'Primary Text', element: 'span', attributes: { 'class': 'uk-text-primary' } },
]);